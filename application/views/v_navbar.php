...
<body>
    ...
    <div class="nav-item" style="padding-top: 0.5%; background-color: #626d7f; width: 100%;height: 75px; margin-bottom: 10px;" >
            ...
            <form  id="formLogin" class="form-inline" method="post" action="<?php echo site_url('welcome/cari') ?>" >
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                ...
                <input type="text" name="inputan" style="width: 100%" class="form-control" id="username" placeholder="cari obatmu">
                
            </div>
            <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1"><a href="<?php echo site_url('welcome/status') ?>"><img id="keranjang" style="width: 75%" src="<?php echo base_url() ?>image/cekPesanan.png"></a></div>
            <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1">
                <a href="<?php echo site_url('welcome/keranjang') ?>"><img id="keranjang" style="width: 75%" src="<?php echo base_url() ?>image/keranjangApotek.png"></a>
            </div> 
